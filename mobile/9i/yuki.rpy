init python:
    ...
    def Snow(image, max_particles=50, speed=150, wind=100, xborder=(0,100), yborder=(50,400), rev=False, **kwargs):
        """
        @parm {image} image:
        ...
        """
        if not rev:
            return Particles(SnowFactory(image, max_particles, speed, wind, xborder, yborder, rev, **kwargs))
        return Particles(SnowFactory(image, max_particles, speed, wind, xborder, yborder, rev, **kwargs))
    ...
    class SnowFactory(object):
        ...
        """
        def __init__(self, image, max_particles, speed, wind, xborder, yborder, rev, **kwargs):
            """
        ...
        def create(self, particles, st):
            ...
            if particles is None or len(particles) < self.max_particles:
                ...
                if self.rev:
                    return [ SnowParticle2(self.image[depth-1],      # the image used by the particle
